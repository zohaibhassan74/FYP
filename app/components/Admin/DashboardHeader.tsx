            ...
            notifications.map((item: any, index: number) => ( */}
              ...
              >
                <div className="w-full flex items-center justify-between p-2">
                  <p className="text-black dark:text-white">New Question raised</p>
                ...
                <p className="p-2 text-black dark:text-white text-[14px]">
                  ...
                  asperiores iusto, ex voluptate nemo delectus! A blanditiis
                  quos nihil, quod porro ipsam, soluta unde eaque animi harum
                  tenetur nobis expedita.
                </p>
              </div>
            {/* ))} */}
        </div>
